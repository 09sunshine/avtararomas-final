...
import {
  ...
  toggleCouponActive as apiToggleCoupon,
...
import { normalizeImageUrl, normalizeImageUrls } from "../../lib/image";
...
const SAMPLE_ORDERS: AdminOrder[] = [
  {
    id: "AVT-001", dbId: "order_sample_001", customer: "Aanya Sharma", email: "aanya@email.com", phone: "+91 98765 43210",
    date: "23 Jul 2025", total: 7598, subtotal: 7598, shipping: 0, discount: 0, status: "Delivered", items: 2,
    paymentStatus: "successful", paymentMethod: "razorpay",
    razorpayOrderId: "order_sample_001", razorpayPaymentId: "pay_sample_001",
    address: "12 MG Road, Bengaluru 560001",
    orderProducts: [
      { name: "Artisanal Oud", qty: 1, price: 4999, image: "https://images.unsplash.com/photo-1771762013405-ad64577dfc55?w=200" },
      { name: "Rose Absolue", qty: 1, price: 2599, image: "https://images.unsplash.com/photo-1615160460524-432433ba1b8f?w=200" },
    ],
  },
  {
    id: "AVT-002", dbId: "order_sample_002", customer: "Rahul Mehta", email: "rahul@email.com", phone: "+91 98123 45678",
    date: "22 Jul 2025", total: 3799, subtotal: 3799, shipping: 0, discount: 0, status: "Shipped", items: 1,
    paymentStatus: "cod", paymentMethod: "cod",
    address: "7 Linking Road, Mumbai 400050",
    orderProducts: [
      { name: "Bois Précieux", qty: 1, price: 3799, image: "https://images.unsplash.com/photo-1774682060959-efe13b7a12b9?w=200" },
    ],
  },
  {
    id: "AVT-003", dbId: "order_sample_003", customer: "Priya Nair", email: "priya@email.com", phone: "+91 97654 32109",
    date: "21 Jul 2025", total: 12597, subtotal: 12597, shipping: 0, discount: 0, status: "Processing", items: 3,
    paymentStatus: "pending", paymentMethod: "razorpay",
    razorpayOrderId: "order_sample_003",
    address: "45 Anna Salai, Chennai 600002",
    orderProducts: [
      { name: "Eau Céleste", qty: 2, price: 3999, image: "https://images.unsplash.com/photo-1778058505479-447c46d800a0?w=200" },
      { name: "Ambre Impérial", qty: 1, price: 4599, image: "https://images.unsplash.com/photo-1774682060997-f8959850a7d4?w=200" },
    ],
  },
  {
    id: "AVT-004", dbId: "order_sample_004", customer: "Vikram Khanna", email: "vikram@email.com", phone: "+91 99887 76655",
    date: "20 Jul 2025", total: 5399, subtotal: 5399, shipping: 0, discount: 0, status: "Cancelled", items: 1,
    paymentStatus: "failed", paymentMethod: "razorpay",
    razorpayOrderId: "order_sample_004",
    address: "18 Connaught Place, Delhi 110001",
    orderProducts: [
      { name: "Fleur de Soie", qty: 1, price: 5399, image: "https://images.unsplash.com/photo-1774682060922-c395859148c9?w=200" },
    ],
  },
  {
    id: "AVT-005", dbId: "order_sample_005", customer: "Sanya Bose", email: "sanya@email.com", phone: "+91 91234 56789",
    date: "19 Jul 2025", total: 8999, subtotal: 8999, shipping: 0, discount: 0, status: "Delivered", items: 1,
    paymentStatus: "successful", paymentMethod: "razorpay",
    razorpayOrderId: "order_sample_005", razorpayPaymentId: "pay_sample_005",
    address: "33 Park Street, Kolkata 700016",
    orderProducts: [
      { name: "Cuir Velours", qty: 1, price: 8999, image: "https://images.unsplash.com/photo-1676951334972-2e65e67f4cbe?w=200" },
    ],
  },
];
...
function mapAdminOrder(order: ApiOrder): AdminOrder {
  return {
    ...
    date: new Intl.DateTimeFormat("en-GB", { day: "2-digit", month: "short", year: "numeric" }).format(new Date(order.createdAt)),
    total: order.total,
...
const EMPTY_FORM: ProductFormData = {
  ...
  ingredients: "", longevity: "", sillage: "",
  season: "", origin: "", concentration: "",
};
...
function SlideDrawer({ open, onClose, title, subtitle, width = "max-w-[620px]", children }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      >
        <div className="flex items-start justify-between px-5 md:px-8 py-6 border-b border-[rgba(201,169,110,0.1)] flex-shrink-0">
          <div>
            <h2 className="text-xl md:text-2xl text-foreground" style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 300 }}>
              {title}
            </h2>
            {subtitle && (
              <p className="text-[10px] md:text-xs text-muted-foreground mt-1" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>{subtitle}</p>
            )}
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 md:px-8 py-7 scrollbar-thin">{children}</div>
      </motion.div>
    </div>
  );
}
...
function CentreModal({ open, onClose, title, children }: {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
      ...
      >
        <div className="flex items-center justify-between px-5 md:px-7 py-5 border-b border-[rgba(201,169,110,0.1)]">
          <h3 className="text-lg md:text-xl text-foreground" style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 300 }}>
            {title}
          </h3>
        ...
        <div className="px-5 md:px-7 py-6">{children}</div>
      </motion.div>
    </div>
  );
}
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center px-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm bg-[#0F0E0D] border border-[rgba(201,169,110,0.15)] p-6 md:p-8 shadow-2xl"
      >
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="border-t border-[rgba(201,169,110,0.08)] pt-6">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <FieldLabel>Top Notes (comma-separated)</FieldLabel>
            <FieldInput value={data.topNotes} onChange={field("topNotes")} placeholder="Saffron, Bergamot, Pink Pepper" />
          </div>
          <div>
            <FieldLabel>Heart Notes (comma-separated)</FieldLabel>
            <FieldInput value={data.heartNotes} onChange={field("heartNotes")} placeholder="Bulgarian Rose, Oud, Jasmine" />
          </div>
          <div>
            <FieldLabel>Base Notes (comma-separated)</FieldLabel>
            <FieldInput value={data.baseNotes} onChange={field("baseNotes")} placeholder="Amber, Sandalwood, White Musk" />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-[rgba(201,169,110,0.08)] pt-6">
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <FieldTextarea rows={3} value={data.ingredients} onChange={field("ingredients")} placeholder="Alcohol Denat., Parfum (Fragrance), Aqua (Water)..." />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <FieldLabel>Concentration</FieldLabel>
              <FieldInput value={data.concentration} onChange={field("concentration")} placeholder="Eau de Parfum" />
            </div>
            <div>
              <FieldLabel>Origin</FieldLabel>
              <FieldInput value={data.origin} onChange={field("origin")} placeholder="Handcrafted in India" />
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <FieldLabel>Longevity</FieldLabel>
              <FieldInput value={data.longevity} onChange={field("longevity")} placeholder="12–18 hours" />
            </div>
            <div>
              <FieldLabel>Sillage</FieldLabel>
              <FieldInput value={data.sillage} onChange={field("sillage")} placeholder="Moderate to Strong" />
            </div>
            <div>
              <FieldLabel>Season</FieldLabel>
              <FieldInput value={data.season} onChange={field("season")} placeholder="All seasons" />
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="flex gap-3 items-center">
                ...
                {data[key] && (
                  <div className="w-12 h-14 border border-[rgba(201,169,110,0.2)] overflow-hidden flex-shrink-0">
                    <img src={normalizeImageUrl(data[key])} className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).style.opacity = "0"; }} />
                  </div>
                )}
              </div>
            </div>
  ...
  const handlePrintInvoice = async () => {
    ...
    try {
      ...
      const invoiceOrder = {
        ...
        items: order.orderProducts.map((p) => ({
          name: p.name,
          price: p.price,
          quantity: p.qty,
        })),
      ...
      const result = await generateAndDownloadInvoice(invoiceOrder);
      if (result.success) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-7">
        {/* Status row */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border border-[rgba(201,169,110,0.1)] bg-[rgba(201,169,110,0.02)] gap-4">
          ...
          <div className="flex items-center gap-2">
            <FieldSelect
              ...
              className="text-xs py-2 px-3 w-full sm:w-36"
            >
        ...
        <div>
          ...
          <p className="text-xs text-primary mt-1" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>
            Contact: <span className="text-foreground font-mono font-normal">{order.phone || "Not provided"}</span>
          </p>
        ...
        {/* Payment Information */}
        {(() => {
          const pc = PAYMENT_STATUS_CFG[order.paymentStatus] || PAYMENT_STATUS_CFG.pending;
          return (
            <div className="p-4 border border-[rgba(201,169,110,0.12)] bg-[#050504]">
              <p className="text-[10px] tracking-[0.35em] uppercase text-primary mb-4" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                Payment Information
              </p>
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>Method</span>
                  <span className="text-xs text-foreground uppercase" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>{order.paymentMethod || "Online"}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>Status</span>
                  <span
                    className="text-[10px] uppercase px-2.5 py-1 border"
                    style={{ borderColor: `${pc.color}40`, backgroundColor: pc.bg, color: pc.color, fontFamily: "var(--font-mono)", fontWeight: 300 }}
                  >
                    {pc.label}
                  </span>
                </div>
                {order.razorpayPaymentId && (
                  <div className="flex items-center justify-between pt-2 border-t border-[rgba(201,169,110,0.08)]">
                    <span className="text-xs text-muted-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>Transaction ID</span>
                    <span className="text-xs text-primary" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>{order.razorpayPaymentId}</span>
                  </div>
                )}
                {order.razorpayOrderId && (
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-muted-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>Razorpay Order</span>
                    <span className="text-xs text-muted-foreground/70" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>{order.razorpayOrderId}</span>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="border-t border-[rgba(201,169,110,0.08)] pt-5 flex flex-col gap-2.5">
          <div className="flex justify-between">
            ...
            <span className="text-xs text-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>{formatPrice(order.subtotal || order.total)}</span>
          </div>
          {(order.discount > 0 || order.couponCode) && (
            <div className="flex justify-between">
              <span className="text-xs text-muted-foreground" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                Discount {order.couponCode ? `(${order.couponCode})` : ""}
              </span>
              <span className="text-xs text-green-400" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>
          ...
          <div className="flex justify-between">
            ...
            <span className="text-xs text-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-3 border border-[rgba(201,169,110,0.2)] text-xs tracking-[0.2em] uppercase text-muted-foreground hover:text-foreground hover:border-primary/40 transition-all disabled:opacity-50"
            style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
          >
          ...
          {order.status !== "Cancelled" && order.status !== "Shipped" && order.status !== "Delivered" && (
            <button
              ...
              className="flex-1 py-3 border border-red-500/20 text-xs tracking-[0.2em] uppercase text-red-400 hover:bg-red-500/5 hover:border-red-500/40 transition-all cursor-pointer"
              style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
            >
              Cancel Order
            </button>
...
function SettingsPanel() {
  ...
  useEffect(() => {
    fetchStoreSettings().then((s) => {
      ...
      setStoreEmail(s.supportEmail);
      setStorePhone(s.phone);
      setGst(s.gst);
      setCurrency(s.currency);
      setFreeAt(String(s.freeShippingThreshold));
      setStdShip(String(s.standardShippingFee));
      setOrderAlerts(s.orderAlerts);
      setStockAlerts(s.stockAlerts);
      setNewsAlerts(s.newsAlerts);
  ...
  const handleSave = async () => {
    ...
    try {
      await apiUpdateSettings({
        ...
        gst,
        currency,
        freeShippingThreshold: Number(freeAt),
        standardShippingFee: Number(stdShip),
        orderAlerts,
        stockAlerts,
        newsAlerts,
        instagram,
  ...
  const Section = ({ icon: Icon, title, children }: { icon: typeof Globe; title: string; children: React.ReactNode }) => (
    <div className="bg-[#0A0908] border border-[rgba(201,169,110,0.1)] p-5 md:p-7 flex flex-col gap-5">
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      {/* Danger zone */}
      <div className="bg-[#0A0908] border border-red-500/15 p-5 md:p-7 flex flex-col gap-5">
        <div className="flex items-center gap-3">
...
export default function AdminDashboard() {
    ...
    const loadDashboard = async () => {
      ...
      try {
        ...
        setAllProducts(productsData.map((p) => ({
          ...
          featured: p.featured,
          isNew: p.is_new,
          topNotes: p.top_notes || undefined,
          heartNotes: p.heart_notes || undefined,
          baseNotes: p.base_notes || undefined,
  ...
  const saveProduct = async () => {
    if (!productForm.name.trim() || productForm.name.trim().length < 2) {
      toast.error("Product name is required (at least 2 characters).");
      return;
    }
    ...
    if (!productForm.description.trim() || productForm.description.trim().length < 5) {
      toast.error("Product description is required (at least 5 characters).");
      return;
    }
    if (!productForm.image1.trim()) {
    ...
    const payload = {
      ...
      images: normalizeImageUrls([productForm.image1, productForm.image2]),
  ...
  return (
    <div className="min-h-screen bg-[#050504] flex relative overflow-x-hidden">
      ...
      {/* ── Sidebar ─────────────────────────────────────────────────────── */}
      <aside className={`fixed inset-y-0 left-0 z-40 w-60 border-r border-[rgba(201,169,110,0.1)] flex flex-col shrink-0 bg-[#050504] h-screen overflow-y-auto transition-transform duration-300 md:translate-x-0 md:static ${
        isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}>
        <div className="p-6 border-b border-[rgba(201,169,110,0.08)] flex items-center justify-between">
          <div>
          ...
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="p-1.5 text-muted-foreground hover:text-foreground md:hidden border border-[rgba(201,169,110,0.15)] rounded bg-[rgba(201,169,110,0.02)]"
      ...
      <div className="flex-1 overflow-auto">
        ...
        {/* Sticky header */}
        <div className="border-b border-[rgba(201,169,110,0.1)] px-4 py-4 md:px-8 md:py-5 sticky top-0 bg-[#050504] z-10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setIsSidebarOpen(true)}
              className="p-2 text-muted-foreground hover:text-foreground md:hidden border border-[rgba(201,169,110,0.15)] rounded bg-[rgba(201,169,110,0.02)]"
              aria-label="Open menu"
            >
              <Menu size={18} strokeWidth={1.5} />
            </button>
              <div>
                <h1 className="text-lg md:text-xl text-foreground" style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 300 }}>
                  {TABS.find((t) => t.id === tab)?.label}
                </h1>
                <p className="text-[10px] md:text-xs text-muted-foreground" style={{ fontFamily: "var(--font-mono)", fontWeight: 300 }}>
          ...
          {tab === "overview" && (
            <div className="flex flex-col gap-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Total Revenue"    value={formatPrice(overview?.revenue || 0)} change="Live" icon={TrendingUp}   up={true} />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[#0A0908] border border-[rgba(201,169,110,0.1)] p-6">
                  ...
                  <ResponsiveContainer width="100%" height={160}>
                    <PieChart>
                      <Pie data={overview?.categoryData || []} cx="50%" cy="50%" innerRadius={40} outerRadius={70} paddingAngle={3} dataKey="value">
                        {(overview?.categoryData || []).map((e) => <Cell key={e.name} fill={e.color} />)}
                      </Pie>
              ...
              <div className="bg-[#0A0908] border border-[rgba(201,169,110,0.1)] p-6">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[500px] md:min-w-0 flex flex-col">
                    {(loadingOrders ? [] : allOrders).slice(0, 4).map((o) => {
          ...
          {tab === "products" && (
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                ...
                <button
                  onClick={openAdd}
                  className="flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-[#080807] text-xs tracking-[0.2em] uppercase hover:bg-[#E8D5B0] transition-colors w-full sm:w-auto"
                  style={{ fontFamily: "var(--font-body)", fontWeight: 400 }}
                >
              ...
              <div className="bg-[#0A0908] border border-[rgba(201,169,110,0.1)] overflow-x-auto">
          ...
          {tab === "orders" && (
            <div>
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex overflow-x-auto border border-[rgba(201,169,110,0.15)] max-w-full divide-x divide-[rgba(201,169,110,0.15)] scrollbar-none">
                  {(["all", ...ALL_STATUSES] as const).map((s) => (
                    <button
                      key={s}
                      onClick={() => setStatusFilter(s)}
                      className={`px-4 py-2.5 text-xs tracking-[0.1em] uppercase transition-all capitalize whitespace-nowrap flex-1 md:flex-none ${
              ...
              <div className="bg-[#0A0908] border border-[rgba(201,169,110,0.1)] overflow-x-auto">
                <table className="w-full min-w-[850px]">
                  ...
                  <tbody>
                    {visibleOrders.map((o) => {
                      const c = STATUS_CFG[o.status];
                      const pc = PAYMENT_STATUS_CFG[o.paymentStatus] || PAYMENT_STATUS_CFG.pending;
                      return (
                        <tr key={o.id} className="border-b border-[rgba(201,169,110,0.05)] hover:bg-[rgba(201,169,110,0.03)] transition-colors">
                          ...
                          <td className="px-5 py-4">
                            <div
                              className="flex items-center gap-1.5 px-2.5 py-1 w-fit border text-[10px] uppercase"
                              style={{ borderColor: `${pc.color}40`, backgroundColor: pc.bg, color: pc.color, fontFamily: "var(--font-mono)", fontWeight: 300 }}
                            >
                              {pc.label}
                            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <p className="text-sm text-muted-foreground" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                  {allCoupons.length} {allCoupons.length === 1 ? "code" : "codes"} · {allCoupons.filter((c) => c.active).length} active
                </p>
                <button
              ...
              {allCoupons.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 border border-[rgba(201,169,110,0.1)] bg-[#0A0908] text-center p-8">
                  <Tag size={40} strokeWidth={0.8} className="text-muted-foreground/60 mb-4" />
                  <h3 className="text-xl text-foreground mb-2" style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 300 }}>
                    No Coupons Available
                  </h3>
                  <p className="text-xs text-muted-foreground mb-6 max-w-sm leading-relaxed" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                    There are currently no discount coupons. Click below to create your first coupon for store customers.
                  </p>
                  <button
                    onClick={() => { setEditingCoupon(null); setCouponModalOpen(true); }}
                    className="flex items-center gap-2 px-6 py-3 bg-primary text-[#080807] text-xs tracking-[0.2em] uppercase hover:bg-[#E8D5B0] transition-colors"
                    style={{ fontFamily: "var(--font-body)", fontWeight: 400 }}
                  >
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <button
                          ...
                          className={`text-[10px] px-2 py-1 border transition-colors ${
                            c.active ? "border-green-500/30 text-green-400 bg-green-500/5 hover:border-red-500/30 hover:text-red-400" : "border-muted-foreground/20 text-muted-foreground hover:border-green-500/30 hover:text-green-400"
                          }`}
      ...
      <OrderDrawer
        ...
        onStatusChange={async (id, s) => {
          ...
          if (order) {
            try {
              await updateOrderStatus(order.dbId, s.toLowerCase());
              const ordersData = await fetchAllOrders();
              setAllOrders(ordersData.map(mapAdminOrder));
              setViewingOrder((prev) => (prev?.id === id ? { ...prev, status: s } : prev));
              toast.success(`Order ${id} has been ${s === "Cancelled" ? "cancelled" : `updated to ${s}`}`);
            } catch (err) {
      ...
      <CouponFormModal
        ...
        onSave={async (c) => {
          try {
            if (editingCoupon) {
              await apiUpdateCoupon(editingCoupon.code, {
                code: c.code,
                discount: c.discount,
                limit: c.limit,
                active: c.active,
              ...
              toast.success(`Coupon ${c.code} updated successfully.`);
            } else {
              ...
              toast.success(`Coupon ${c.code} created successfully.`);
            }
            await refreshCoupons();
          } catch (err: any) {
      ...
      <DeleteConfirm
        ...
        onConfirm={() => deleteProductId && deleteProductHandler(deleteProductId)}
      ...
      <DeleteConfirm
        ...
        onConfirm={async () => {
          if (deleteCouponCode) {
            try {
              await apiDeleteCoupon(deleteCouponCode);
              toast.success(`Coupon ${deleteCouponCode} deleted.`);
              await refreshCoupons();
            } catch (err: any) {
